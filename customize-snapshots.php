...
if ( version_compare( phpversion(), '5.3', '>=' ) ) {
	...
	$class_name = '\CustomizeSnapshots\Plugin';
	$GLOBALS['customize_snapshots_plugin'] = new $class_name();
} else {
	...
	if ( defined( 'WP_CLI' ) ) {
		WP_CLI::warning( __( 'Customize Snapshots plugin error: Your PHP version is too old. You must have 5.3 or higher.', 'customize-snapshots' ) );
	} else {
