 ...
 * @package CustomizeSnapshots
 */
class Customize_Snapshot_Back_Compat extends Customize_Snapshot {
	 ...
	 *
	 * @param Customize_Snapshot_Manager_Back_Compat $snapshot_manager Customize snapshot bootstrap instance.
	 * @param string                                 $uuid             Snapshot unique identifier.
	 */
	public function __construct( $snapshot_manager, $uuid ) {
