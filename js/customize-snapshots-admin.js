...
var CustomizeSnapshotsAdmin = (function( $ ) {
	...
	component.splitSnapshot = function( event ) {
		...
		if ( component.splitCheckbox.hasClass( splitClassName ) ) {
			component.splitCheckbox.removeClass( splitClassName );
			component.splitButton.text( component.splitButton.data( 'cancel-text' ) );
		} else {
			component.splitCheckbox.removeAttr( 'checked' );
			component.splitCheckbox.addClass( splitClassName );
			component.splitButton.text( component.splitButton.data( 'original-text' ) );
		}
		event.preventDefault();
	};
